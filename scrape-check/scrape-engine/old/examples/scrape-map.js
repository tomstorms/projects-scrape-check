...
let scrape = async () => { // Prepare scrape...
  ...
  await page.goto('https://www.google.co.th/maps?q=cmor+google+maps&um=1&ie=UTF-8&sa=X&ved=0ahUKEwiQ84bguq_eAhXGF3IKHfzcCCcQ_AUIDigB'); // Define the Maps URL to Scrape...
